...
const ProfileDrawer: FC<ProfileDrawerProps> = ({ data, isOpen, onClose }) => {
  ...
  const joinedDate = useMemo(() => format(new Date(otherUser.createdAd), 'PP'), [otherUser.createdAd]);
                      ...
                      <div className='relative mt-6 flex-1 px-4 sm:px-6'>
                        <div className='flex flex-col items-center'>
                          ...
                          <div className='flex gap-10 my-8'>
                            <button type='button' onClick={() => setConfirmModal(true)} className='flex flex-col gap-3 items-center cursor-pointer hover:opacity-75'>
